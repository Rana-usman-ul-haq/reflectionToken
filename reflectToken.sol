...
contract ReflectionToken is Context, IERC20, Ownable {
    ...
    address public treasuryWallet=0x5B38Da6a701c568545dCfcB03FcB875f56beddC4; // put treasuryWallet address 
    address public teamWallet=0x5B38Da6a701c568545dCfcB03FcB875f56beddC4;// put teamWallet address after
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee) private {
        ...
        if(recipient != uniswapV2Pair){
            ...
            _rOwned[teamWallet] = _rOwned[teamWallet].add(_toteamWallet);
            _tOwned[teamWallet] = _tOwned[teamWallet].add(_toteamWallet);
            _rOwned[treasuryWallet] = _rOwned[treasuryWallet].add(_toTeam);
            _tOwned[treasuryWallet] = _tOwned[treasuryWallet].add(_toTeam);

            amount = amount.sub(_toteamWallet).sub(_toTeam);
        }
